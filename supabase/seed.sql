...
values
  ...
  (6, 'H-42', 'NRG', 'Yes', 'Exclusive for ASINs we create under Skin Revolution', '', '', '', '', null, 'Active', '', ''),
  (7, 'Inglot', 'NRG', 'No', 'Reseller', '', '', '', '', null, 'Active', '', 'Also on TBB/TB list (Semi-Exclusive)'),
  (8, 'Kitoko', 'NRG', 'No', 'Reseller', '', '', '', '', null, 'Active', '', ''),
  (9, 'Leather Luster', 'NRG', 'Yes', 'Exclusive for ASINs we create under Skin Revolution', '', '', '', '', null, 'Active', '', ''),
  (10, 'Midway', 'NRG', 'No', 'Reseller', '', '', '', '', null, 'Active', '', ''),
  (11, 'Milagros', 'NRG', 'Yes', 'Exclusive for ASINs we create under Skin Revolution', '', '', '', '', null, 'Active', '', ''),
  (12, 'Mina Brow', 'NRG', 'Yes', 'Exclusive', '', '', '', '', null, 'Active', '', ''),
  (13, 'Olé Capilar', 'NRG', 'Yes', 'Exclusive for ASINs we create under Skin Revolution', '', '', '', '', null, 'Active', '', ''),
  (14, 'Ritual Botanico', 'NRG', 'Yes', 'Exclusive for ASINs we create under Skin Revolution', '', '', '', '', null, 'Active', '', ''),
  ...
  (33, 'French Farm', 'TBB', 'N/A', 'Created new ASINs under TBB Brand Registry', '', '', '', '', null, 'Active', '', ''),
  ...
  (47, 'Orange Chronic', 'TBB', 'N/A', 'Created new ASINs under TBB Brand Registry', '', '', '', '', null, 'Active', '', ''),
