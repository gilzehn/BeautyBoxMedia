...
-- Creates: public.brands, public.dropdown_options, seeds 58 brands + 21 options.
-- Safe to re-run: tables use IF NOT EXISTS and the seed upserts by id.
-- ============================================================
